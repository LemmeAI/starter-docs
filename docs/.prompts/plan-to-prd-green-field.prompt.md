...
description: Instructs the agent to generate a comprehensive set of PRD documents based from a specific plan document. If there are already requirements documents in `docs/prd`, they will be archived in a dated sub-folder (per agent instructions in `AGENTS.md` and `CLAUDE.md`).
___
